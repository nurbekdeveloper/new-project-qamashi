...
import Person_5 from '../styles/projects/person_5.jpg';
import Person_6 from '../styles/projects/person_6.jpg';
import Person_7 from '../styles/projects/person_7.jpg';
...
export  const projects = [
    {
        id:1,
        name: 'Yoqubova Nargiza Abdurasul qizi', //project name
    ...
    {
        id:2,
        name: 'Shoymurodov Sanjar Toshboltayevich', //project name
    ...
    {
        id:3,
        name: 'Qayimov Akmal Anvar o`g`li', //project name
    ...
    {
        id:4,
        name: 'Ulashov Nasriddin Baxriddin o`g`li', //project name
    ...
    {
        id:5,
        name: 'Keldiyorov Mirjalol Mamasodiqovich', //project name
    ...
    {
        id:6,
        name: 'Kenjayev Faxriddin Baxriddin o`g`li', //project name
    ...
    {
        id:7,
        name: "Ibadov Arslonbek Xomid o'g'li", //project name
    ...
    {
        id:8,
        name: ' Karimov Sardorbek Xolbozor o`g`li', //project name
    ...
    {
        id:9,
        name: 'Rasulov Furqat Ziyodullo o`g`li', //project name
    ...
    {
        id:10,
        name: 'Jurayev Jasur Bozorovich', //project name
        description: "2022-yil 24-yanvardan:Yoshlar ishlari agentligining Qamashi tumani 'Zafar'  mahalla fuqorolar yig'inidagi yoshlar vakili" ,
        githubLink: '', //github repo link
        projectLink: '', //deployed project link
        telegramLink:'',
        tech: ['Tech1', 'Tech2', 'Tech3'], //techstack of the project, it is advisavble to mention only upto 3 technologies here to maintain the ui
