        ...
        <div className={styles.footermain} style={{ backgroundColor: currentTheme.footerColor, color: currentTheme.subtext }}>
            <div className={styles.footertable}>
                ...
                <ul>
                    ...
                    <Link href='/'><a><li>Asosiy</li></a></Link>
                    <Link href='/#about'><a><li>Biz haqimizda</li></a></Link>
                    <Link href='/work'><a><li>Yangiliklar</li></a></Link>
                    <Link href='/contact'><a><li>Bog`lanish</li></a></Link>
                </ul>
            </div>
            <hr style={{ height: '1px', backgroundColor: currentTheme.subtext, border: 'none', opacity: '0.5' }}></hr>
            <h2 className={styles.footercontent}>Website Sarvara Urozova tomonidan tayyorlandi</h2>
        </div>
    )
}
